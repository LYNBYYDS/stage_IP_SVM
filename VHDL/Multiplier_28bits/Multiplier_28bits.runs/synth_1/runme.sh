...
HD_PWD='C:/Users/liyon/Desktop/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplier_28bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Multiplier_28bits.tcl
