...
HD_PWD='C:/Users/liyon/Desktop/Exponential/Exponential.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Exponential.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Exponential.tcl
