...
HD_PWD='C:/Users/liyon/Desktop/Subtractor_28bits/Subtractor_28bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Subtractor_28bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Subtractor_28bits.tcl
