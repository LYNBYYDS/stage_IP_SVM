...
HD_PWD='C:/Users/liyon/Desktop/Kernel_rbf/Kernel_rbf.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Kernel_rbf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Kernel_rbf.tcl
